...
public class ImporterV3 extends Importer {
    ...
    public PwDatabaseV3 openDatabase(InputStream inStream, String password, InputStream kfIs, MyProgressTask status)
            throws IOException, InvalidDBException {
    ...
    private void readEntryField(PwDatabaseV3 db, PwEntryV3 ent, byte[] buf, int offset)
            throws UnsupportedEncodingException {
